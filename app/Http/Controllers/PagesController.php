...
public function posttaodetch(Request $rq)
{
  $chuong=chuong::select('idChuong')->where('idMH',$rq->mh)->get()->toArray();
  ...
  $cauhoi4=cauhoi::select()->where('doKho',1)->get();
  $cauhoi5=cauhoi::select()->where('doKho',2)->get();
  $cauhoi6=cauhoi::select()->where('doKho',3)->get();
